...
const EMOJIS = ['\U0001f50d','\U0001f550','\U0001f310','\U0001f5a5\ufe0f','\U0001f4d6','\U0001f4dd','\U0001f3e0','\U0001f3ac','\U0001f6e1\ufe0f','\U0001f4ca','\U0001f433','\U0001f510','\U0001f419','\U0001f98a','\U0001f4da','\U0001f4e6','\U0001f40d','\U0001f4ac','\u25b6\ufe0f','\U0001f3ae','\U0001f426','\U0001f30d','\u269b\ufe0f','\U0001f4d8','\u2694\ufe0f','\u2699\ufe0f','\U0001f504','\u2715','\U0001f517','\U0001f31f','\U0001f525','\U0001f4a1','\U0001f680','\u26a1','\U0001f3af','\U0001fa9f','\U0001fa90','\U0001f4e1','\U0001f527','\U0001f5c4\ufe0f','\U0001f4be','\U0001f5a8\ufe0f','\U0001f4f7','\U0001f3a5','\U0001f3b5','\U0001f399\ufe0f','\U0001f4fb','\U0001f4fa','\U0001f4bb','\u2328\ufe0f','\U0001f5b1\ufe0f','\U0001f4f1','\U0001f4bd','\U0001f4bf','\U0001f4c0','\U0001f50c','\U0001f50b','\U0001f48e','\U0001f9ca','\u26c5','\U00002600\ufe0f','\U0001f319','\u2b50','\u2728','\U0001f4ab','\U0001f386','\U0001f308','\u2601\ufe0f','\U0001f30a','\U0001f525','\U0001f343','\U0001f331','\U0001f33f','\u2618\ufe0f','\U0001f340','\U0001f3c6','\U0001f947','\U0001f948','\U0001f949','\U0001f3c5','\U0001f3c1','\U0001f6a9','\U0001f38c','\U0001f4cc','\U0001f4cd','\U0001f3aa','\U0001f3ad','\U0001f3a8','\U0001f3ac','\U0001f3a4','\U0001f3a7','\U0001f3bc','\U0001f3b9','\U0001f941','\U0001f3b7','\U0001f3b8','\U0001f3ba','\U0001f3bb','\U0001f3b2','\u265f\ufe0f','\U0001f3af','\U0001f3b3','\U0001f3ae','\U0001f579\ufe0f','\U0001f3b0','\U0001f3b2','\U0001fa9f','\u2660\ufe0f','\u2665\ufe0f','\u2666\ufe0f','\u2663\ufe0f'];
...
function iconField(card){const g=document.createElement('div');g.style.cssText='margin-bottom:8px;';const l=document.createElement('label');l.style.cssText='display:block;font-size:11px;font-weight:600;color:var(--text-secondary);margin-bottom:2px;';l.textContent='Icon';g.appendChild(l);const row=document.createElement('div');row.style.cssText='display:flex;gap:6px;align-items:center;';const p=document.createElement('span');p.style.cssText='font-size:24px;width:32px;height:32px;text-align:center;display:flex;align-items:center;justify-content:center;';if(card.icon&&(card.icon.startsWith('http')||card.icon.startsWith('data:'))){const img=document.createElement('img');img.src=card.icon;img.style.cssText='width:28px;height:28px;object-fit:contain;';p.appendChild(img);}else if(isLucideName(card.icon)){p.appendChild(renderLucideEl(card.icon,'card-icon'));}else{p.textContent=card.icon||'📦';}row.appendChild(p);const b=document.createElement('button');b.className='btn btn-glass btn-sm';b.textContent='Change';b.addEventListener('click',()=>openIconPicker(url=>{card.icon=url;saveConfig();renderAll();}));row.appendChild(b);const cb=document.createElement('button');cb.className='btn btn-glass btn-sm';cb.textContent='✕';cb.addEventListener('click',()=>{card.icon='package';saveConfig();renderAll();});row.appendChild(cb);g.appendChild(row);return g;}
...
function buildIconPicker(t){const c=$('#icon-picker-content');c.innerHTML='';$$('.ip-tab').forEach(x=>x.classList.toggle('active',x.dataset.tab===t));if(t==='library')buildLibraryTab(c);else if(t==='upload')buildUploadTab(c);else if(t==='emoji')buildEmojiTab(c);else if(t==='icons')buildIconsTab(c);else if(t==='url')buildUrlTab(c);}
...
function buildIconsTab(c){
  ...
  function ri(f){g.innerHTML='';const fl=(f||'').toLowerCase();const items=fl?LUCIDE_ICONS.filter(n=>n.includes(fl)):LUCIDE_ICONS;
  ...
  }s.addEventListener('input',()=>ri(s.value));ri('');setTimeout(()=>{if(typeof lucide!=='undefined')lucide.createIcons();},0);}
